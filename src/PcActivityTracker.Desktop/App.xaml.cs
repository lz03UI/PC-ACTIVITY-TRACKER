...
public partial class App : Application
{
    ...
    protected override async void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        var documentResolvers = new DocumentResolverRegistry(
            [new WordDocumentContextResolver(new WordComDocumentFacade()), new ExcelDocumentContextResolver(new ExcelComDocumentFacade())],
