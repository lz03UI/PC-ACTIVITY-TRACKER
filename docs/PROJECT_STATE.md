...
Validare Word COM su Windows reale (documento locale, unsaved, Protected View, access denied e chiusura durante la risoluzione), quindi aggiungere un secondo resolver Tier 1 con la stessa pipeline senza estendere lo scope.
